...
function mountPurgeXPanel(defaultConfig = PurgeXCore.DEFAULT_CONFIG) {
  ...
  panel.innerHTML = `
    ...
    <form id="purgex-form">
      ...
      <div class="actions-row"><button type="button" id="purgex-reset">Reset</button><button type="submit" class="primary">Run</button></div>
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { PurgeXCore, runPurgeX, mountPurgeXPanel };
} else if (typeof window !== 'undefined' && typeof document !== 'undefined') {
  window.PurgeX = { core: PurgeXCore, run: runPurgeX, mountPanel: mountPurgeXPanel };
